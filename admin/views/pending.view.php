...
<script type="text/javascript">
  $(document).ready(function(){
    $('#table_id').dataTable({
     "bProcessing": true,
     "sAjaxSource": "../controller/get_pending.php",
     "responsive": true,
     "bPaginate":true,
     "aaSorting": [[1,'desc']],
    ...
    'searchable': false,
    "mRender" : function (data) {
      return "<a class='btn btn-small btn-primary' href='../controller/edit_pending.php?id="+data.deal_id+"'>"+EDITITEM+"</a>";}
    }
    ]
  });
  });
    ...
    <div class="content sm-gutter">
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <div class="section-title">
          <h5 class="text-truncate"><?php echo _NEWSUBMISSIONS; ?></h5>
        </div>
