    ...
    <div class="content sm-gutter">
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <?php endif; ?>
                ...
                <hr>
                <p class="mb-0"><?php echo echoOutput((isset($deal['author_message']) ? $deal['author_message'] : "")); ?></p>
                </div>
                ...
                <button class="btn btn-danger" type="submit" value="rejected" name="submit"><?php echo _REJECTITEM; ?></button>
                </div>
